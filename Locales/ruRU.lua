...
L["ElvUI is five or more revisions out of date. You can download the newest version from https://github.com/ElvUI-WotLK/ElvUI"] = "Ваш ElvUI устарел более, чем на 5 версий. Обновите его на https://github.com/accidev/ElvUI "
L["ElvUI is out of date. You can download the newest version from https://github.com/ElvUI-WotLK/ElvUI"] = "ElvUI устарел. Вы можете скачать последнюю версию с https://github.com/accidev/ElvUI"
...
L["ElvUI was updated while the game is still running. Please relaunch the game, as this is required for the files to be properly updated."] = "ElvUI обновился, вы можете скачать последнюю версию с https://github.com/accidev/ElvUI"
...
L["For technical support visit us at https://github.com/ElvUI-WotLK."] = "За технической поддержкой обращайтесь на https://github.com/accidev/ElvUI"
L["Frame"] = "Рамка"
...
L["KEY_SPACE"] = "SpB"
L["Key"] = "Клавиша"
L["LOGIN_MSG"] = "Добро пожаловать в %sElvUI|r версии %s%s|r, наберите /ec для доступа в меню настроек. Если Вам нужна техническая поддержка, посетите наш форум на https://github.com/accidev/ElvUI или присоединяйтесь к серверу Discord: https://discord.gg/addonsforsirus"
...
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/accidev/ElvUI"] = "Вы завершили процесс установки. Если Вам требуется техническая поддержка, посетите сайт https://github.com/accidev/ElvUI"
