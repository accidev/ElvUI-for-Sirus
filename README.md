...
Тут только код без настроек, настройки в https://github.com/accidev/ElvUI_OptionsUI
...
1. Тыкаем по ссылке **[Latest Version](https://github.com/accidev/ElvUI/releases/latest)**
...
Убедитесь что вы используете последнюю версию [ElvUI](https://github.com/accidev/ElvUI/releases/latest)
<br />
