...
local function LoadSkin()
	...
	local extractBtn = CreateFrame("Button", "ElvUI_ExtractDiamondsButton", CharacterModelFrame, "UIPanelButtonTemplate")
	extractBtn:Size(100, 22)
	extractBtn:Point("BOTTOM", CharacterModelFrame, "TOP", -55, 5)
	extractBtn:SetText("Достать ЧБ")
	S:HandleButton(extractBtn)
	extractBtn:SetScript("OnClick", function()
		E:GetModule("Sirus"):ExtractBlackDiamonds()
	end)

	local insertBtn = CreateFrame("Button", "ElvUI_InsertDiamondsButton", CharacterModelFrame, "UIPanelButtonTemplate")
	insertBtn:Size(100, 22)
	insertBtn:Point("BOTTOM", CharacterModelFrame, "TOP", 55, 5)
	insertBtn:SetText("Вставить ЧБ")
	S:HandleButton(insertBtn)
	insertBtn:SetScript("OnClick", function()
		E:GetModule("Sirus"):InsertBlackDiamonds()
	end)
